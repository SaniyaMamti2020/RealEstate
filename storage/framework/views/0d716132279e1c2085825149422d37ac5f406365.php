            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?php echo Form::model($generalSetting, [
                        'route' => 'general-setting.store',
                        'role' => 'form',
                        'id' => 'generalSettingForm',
                        'class' => 'form-horizontal generalSettingForm',
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                            <div class="form-group">
                                ...
                                <?php echo Form::text('project_title', null, [
                                    'class' => 'form-control',
                                    'id' => 'project_title',
                                    'maxlength' => '200',
                                ]); ?>
                    ...
                    <div class="row mt-2">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3">
                            ...
                            <img alt="Logo"
                                src="<?php echo e(isset($generalSetting['icon_img']) && !empty($generalSetting['icon_img']) ? asset('/upload/generalsetting/' . $generalSetting['icon_img']) : asset('/media/no-image.png')); ?>"
                                class="pt-10
                        align-self-end" id="icon_preview" name="icon_preview"
                                style="width: 25%;">
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3">
                            ...
                            <img alt="Logo"
                                src="<?php echo e(isset($generalSetting['logo_img']) && !empty($generalSetting['logo_img']) ? asset('/upload/generalsetting/' . $generalSetting['logo_img']) : asset('/media/no-image.png')); ?>"
                                class="pt-10
                        align-self-end" id="logo_preview" name="logo_preview"
                                style="width: 25%;">
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3">
                            ...
                            <img alt="Logo"
                                src="<?php echo e(isset($generalSetting['footer_logo_img']) && !empty($generalSetting['footer_logo_img']) ? asset('/upload/generalsetting/' . $generalSetting['footer_logo_img']) : asset('/media/no-image.png')); ?>"
                                class="pt-10
                        align-self-end" id="footer_logo_preview"
                                name="footer_logo_preview" style="width: 25%;">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="mb-3">
                                ...
                                <?php echo Form::text('page_meta_tag', null, [
                                    'class' => 'form-control',
                                    'id' => 'page_meta_tag',
                                    'rows' => '3',
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="mb-3">
                                ...
                                <?php echo Form::textarea('page_meta_desc', null, [
                                    'class' => 'form-control',
                                    'id' => 'page_meta_desc',
                                    'rows' => '3',
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="submit"
                                class="btn btn-primary"><?php echo e(!isset($generalSetting) ? __('common.save') : __('common.update')); ?></button>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RealEstate\resources\views/admin/general-setting/index.blade.php ENDPATH**/ ?>