    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <!-- Start Form -->
                    <?php echo Form::model($socialMedia, [
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="submit"
                                class="btn btn-primary"><?php echo e(!isset($socialMedia) ? __('common.save') : __('common.update')); ?></button>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RealEstate\resources\views/admin/social-media/index.blade.php ENDPATH**/ ?>