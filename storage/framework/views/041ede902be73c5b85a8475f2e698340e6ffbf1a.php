            ...
            <div class="col-sm-6">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('testimonial-create')): ?>
                    <a class="btn btn-primary float-end mb-4"
                        href="<?php echo e(route('testimonial.create')); ?>"><?php echo e(__('common.add')); ?></a>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RealEstate\resources\views/admin/testimonial/index.blade.php ENDPATH**/ ?>