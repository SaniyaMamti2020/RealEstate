                ...
                <tr>
                  <th>
                    <div class="col-sm-8 datatable-form-filter no-padding">
                        {!! Form::text('filter_username', Request::get('filter_username',null), array('class' => 'form-control')) !!}
                    </div>
                  </th>
                  <th>
                    <div class="col-sm-8 datatable-form-filter no-padding">
                        {!! Form::text('filter_email', Request::get('filter_email',null), array('class' => 'form-control')) !!}
                    </div>
                  </th>
                  <th></th>
                  <th></th>
