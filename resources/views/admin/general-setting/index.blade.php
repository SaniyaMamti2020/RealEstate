                ...
                <div class="card-body">
                    ...
                    <div class="row mt-2">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3">
                            ...
                            <img alt="Logo"
                                src="{{ isset($generalSetting['icon_img']) && !empty($generalSetting['icon_img']) ? asset('/upload/generalsetting/' . $generalSetting['icon_img']) : asset('/media/no-image.png') }}"
                                class="pt-10
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3">
                            ...
                            <img alt="Logo"
                                src="{{ isset($generalSetting['logo_img']) && !empty($generalSetting['logo_img']) ? asset('/upload/generalsetting/' . $generalSetting['logo_img']) : asset('/media/no-image.png') }}"
                                class="pt-10
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-3">
                            ...
                            <img alt="Logo"
                                src="{{ isset($generalSetting['footer_logo_img']) && !empty($generalSetting['footer_logo_img']) ? asset('/upload/generalsetting/' . $generalSetting['footer_logo_img']) : asset('/media/no-image.png') }}"
                                class="pt-10
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="submit"
                                class="btn btn-primary">{{ !isset($generalSetting) ? __('common.save') : __('common.update') }}</button>
