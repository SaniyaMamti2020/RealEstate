            ...
            <table class="table table-sm table-bordered table-permission">
                ...
                <tbody>
                    ...
                    @foreach ($permission as $value)
                        ...
                        {{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, ['class' => 'name ms-3']) }}
                        {{ $value->name }}
                        @if ($a == 4)
                            @php
                                $a = 0;
            ...
            <table class="table table-sm table-bordered table-permission">
                ...
                <tbody>
                    ...
                    @foreach ($permission as $value)
                        ...
                        {{ Form::checkbox('permission[]', $value->id, false, ['class' => 'name ms-3']) }}
                        {{ $value->name }}
                        @if ($a == 4)
                            @php
                                $a = 0;
...
<div class="row">
    <div class="col-sm-12">
        <button type="submit"
            class="btn btn-primary">{{ !isset($page) ? __('common.save') : __('common.update') }}</button>
