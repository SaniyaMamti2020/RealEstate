<div class="row">
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-12">
		<div class="mb-3">
			...
			{!! Form::text('designation', null, ['class' => 'form-control required','id' => 'designation','maxlength'=>'75']) !!}
		</div>	
	</div>
  ...
  <div class="col-lg-4 col-md-4 col-sm-4 col-4">  
  	@if(isset($testimonial) && $testimonial->image != '' && !empty($testimonial->image))
			<div class="image_delete" data-id="{{$testimonial->id}}">
				<img alt="Image" src="{{(isset($testimonial['image']) && !empty($testimonial['image'])) ? asset("/upload/testimonial/".$testimonial['image'])  : asset('/media/no-image.png')}}" class="pt-10 align-self-end" id="img_preview" name="img_preview" style="width: 50%;">	
			</div>
		@else
...
<div class="row">
  <div class="col-sm-12">
      <button type="submit" class="btn btn-primary">{{( !isset($testimonial)) ? __('common.save') : __('common.update')}}</button>
