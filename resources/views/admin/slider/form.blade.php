<div class="row">
  ...
  <div class="col-lg-4 col-md-4 col-sm-4 col-4">  
  	@if(isset($slider) && $slider->slider_img != '' && !empty($slider->slider_img))
			<div class="image_delete" data-id="{{$slider->id}}"><img alt="Image" src="{{(isset($slider['slider_img']) && !empty($slider['slider_img'])) ? asset("/upload/slider/".$slider['slider_img'])  : asset('/media/no-image.png')}}" class="pt-10 align-self-end" id="img_preview" name="img_preview" style="width: 50%;">	
			</div>
		@else
    	<img alt="" src="" class="pt-10 align-self-end" id="img_preview" name="img_preview" style="width: 50%;">	
    @endif
	</div>
	<div class="col-lg-6 col-md-6 col-sm-6 col-12">
		<div class="mb-3">
...
<div class="row">
  <div class="col-sm-12">
      <button type="submit" class="btn btn-primary">{{( !isset($slider)) ? __('common.save') : __('common.update')}}</button>
