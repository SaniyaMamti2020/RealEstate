                ...
                <tr>
                  <th>
                    <div class="col-sm-8 datatable-form-filter no-padding">
                        {!! Form::text('filter_title', Request::get('filter_title',null), array('class' => 'form-control')) !!}
                    </div>
                  </th>
                  <th>
                    <div class="col-sm-8 datatable-form-filter no-padding">
                        {!! Form::text('filter_sub_title', Request::get('filter_sub_title',null), array('class' => 'form-control')) !!}
                    </div>
                  </th>
                  <th></th>
                  <th></th>
