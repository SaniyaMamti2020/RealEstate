  ...
  <div class="col-lg-2 col-md-2 col-sm-2 col-4">  
  	@if(isset($pages) && $pages->page_img != '' && !empty($pages->page_img))
			<div class="image_delete" data-id="{{$pages->id}}">
				<span style="cursor: pointer;" class="page text-danger">X</span><img alt="Image" src="{{asset("/upload/pages/".$pages['page_img'])}}" class="pt-10 align-self-end" id="img_preview" name="img_preview" style="width: 50%;">	
			</div>
		@else
