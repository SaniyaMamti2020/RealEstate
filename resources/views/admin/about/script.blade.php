    ...
    $(document).on('click','.image_delete',function(){
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            $.ajax({
              url: '{{url('/admin/page-image-delete')}}/'+id,
              type: "GET",
              data: {
                id: id,
              },
              success: function(response) {
                $('.image_delete').html('<img alt="Image" src="{{asset('/media/no-image.png')}}" class="pt-10 align-self-end" id="img_preview" name="img_preview" style="width: 50%;">');
                if(response!=0)
                {
                  Swal.fire(
                    'Deleted!',
